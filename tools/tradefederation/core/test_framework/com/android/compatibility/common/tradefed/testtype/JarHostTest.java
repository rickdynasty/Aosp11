...
/**
 * Test runner for host-side JUnit tests. Package is mis-aligned for historic & backward
...
public class JarHostTest extends HostTest {
     ...
     * embedded listener. Each test class in the jar will invoke these events, which
