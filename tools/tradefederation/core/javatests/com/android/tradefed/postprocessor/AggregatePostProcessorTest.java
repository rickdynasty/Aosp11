...
public class AggregatePostProcessorTest {
    ...
    /** Test reporting percentiles. */
    @Test
    public void testPercentiles() throws ConfigurationException {
        OptionSetter setter = new OptionSetter(mProcessor);
        setter.setOptionValue("report-percentiles", "7");
        setter.setOptionValue("report-percentiles", "54");
        setter.setOptionValue("report-percentiles", "97");
        ...
        Assert.assertTrue(
                processedMetrics.containsKey(
                        listDoubleKey + STATS_KEY_SEPARATOR + STATS_KEY_PERCENTILE_PREFIX + "7"));
        Assert.assertEquals(
                listDoubleStats.get(STATS_KEY_PERCENTILE_PREFIX + "7"),
                processedMetrics
                        .get(
                                listDoubleKey
                                        + STATS_KEY_SEPARATOR
                                        + STATS_KEY_PERCENTILE_PREFIX
                                        + "7")
                        .build()
                        .getMeasurements()
                        .getSingleString());
        Assert.assertTrue(
                processedMetrics.containsKey(
                        listDoubleKey + STATS_KEY_SEPARATOR + STATS_KEY_PERCENTILE_PREFIX + "54"));
        Assert.assertEquals(
                listDoubleStats.get(STATS_KEY_PERCENTILE_PREFIX + "54"),
                processedMetrics
                        .get(
                                listDoubleKey
                                        + STATS_KEY_SEPARATOR
        ...
        Assert.assertTrue(
                processedMetrics.containsKey(
                        listDoubleKey + STATS_KEY_SEPARATOR + STATS_KEY_PERCENTILE_PREFIX + "97"));
        Assert.assertEquals(
                listDoubleStats.get(STATS_KEY_PERCENTILE_PREFIX + "97"),
                processedMetrics
                        .get(
                                listDoubleKey
                                        + STATS_KEY_SEPARATOR
    ...
    /** Test that the 50 percentile is reported if the user asks (even if median is reported). */
    @Test
    public void testReports50PercentileIfSpecified() throws ConfigurationException {
        OptionSetter setter = new OptionSetter(mProcessor);
        setter.setOptionValue("report-percentiles", "50");
        ...
        HashMap<String, String> listDoubleStats = new HashMap<String, String>();
        listDoubleStats.put(STATS_KEY_MEDIAN, "2.05");
        listDoubleStats.put(STATS_KEY_PERCENTILE_PREFIX + "50", "2.05");
        ...
        Assert.assertTrue(
                processedMetrics.containsKey(
                        listDoubleKey + STATS_KEY_SEPARATOR + STATS_KEY_PERCENTILE_PREFIX + "50"));
        Assert.assertEquals(
                listDoubleStats.get(STATS_KEY_PERCENTILE_PREFIX + "50"),
                processedMetrics
                        .get(
                                listDoubleKey
                                        + STATS_KEY_SEPARATOR
